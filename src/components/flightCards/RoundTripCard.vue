            ...
            <div :class="i.outbound[0].refundable ? 'refundable' : 'not-refundable'">{{i.outbound[0].refundable ? 'Refundable' : 'Non Refundable'}}</div>
                  ...
                  <div class="actual-result-item-info">
                    <div>
                      ...
                      <div class="more-flight-info">
                        ...
                        <span class="stops">{{ i.outbound_stops === 0 ? 'Non-stop' :
              ...
              <div class="actual-result-item" v-for="j in i.outbound">
                  ...
                  <div class="more-flight-info">
                      ...
                      <span class="stops">{{ i.outbound_stops + i.inbound_stops === 0 ? 'Non-stop' :
              ...
              <div class="actual-result-item" v-if="index === i.inbound?.length - 1">
                  ...
                  <div class="more-flight-info">
                      ...
                      <span class="stops">{{ i.inbound_stops === 0 ? 'Non-stop' :
              ...
              <div class="component87 animate__animated animate__fadeIn">
                <div >
                  ...
                  <div style="width: inherit;display:flex;overflow-x: scroll;">
                    ...
                    <div v-for="j in i.outbound" style="display: flex;align-items: center;">
                      ...
                      <div class="layover">
                        <div style="display:flex;align-items: center">
                          ...
                          <p style="transform: rotate(180deg);width:10.125rem;font-size: 0.75rem;">3h 56m layover in casablana</p>
                        </div>
                      </div>
                    </div>
                    </div>
