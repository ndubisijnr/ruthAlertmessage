            ...
            <div class="third-invoice-row-and-table">
              <div>
                ...
                <div class="container" style="display: flex;justify-content: space-around">
                  ...
                  <p class="date">Tues 19th Sept, 2023</p>
                </div>

                <div class="container" style="display: flex;justify-content: center;gap:3.37rem">
                  <div >
                    <p class="time" style="display: flex;align-items: center;">01 : 00 PM <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
