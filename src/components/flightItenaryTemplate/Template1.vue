        ...
        <div id="pdf-to-download">
          ...
          <div class="third-invoice-row-and-table">
            ...
            <div class="flight_info_wrapper">
              <p>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <g clip-path="url(#clip0_2645_19022)">
          ...
          <div class="flight_info_wrapper">
            <div class="equal-height-table">
              <div class="equal-height-table_item">
                <p class="flight_info_text">Passenger Name </p>

                <p class="flight_info_text">Email</p>
              </div>
              <div>
                <p class="flight_info_text">Ticket </p>
              </div>
            </div>
          </div>
          ...
          <div class="flight_info_wrapper">
            ...
            <div class="last-row">
              <h4 class="ticket_reciept_text"><span class="sub-total">Ticket Fare :</span> 10000</h4>
              <h4 class="ticket_reciept_text">Total : 15000 </h4>
