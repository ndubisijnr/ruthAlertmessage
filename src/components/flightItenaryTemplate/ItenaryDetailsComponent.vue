...
export default{
  ...
  props:['getUser','getBookedFlight','getSelectedFlight', "id", 'flightId'],
  data(){
    return{
      isPaying:false,
  ...
  methods:{
    ...
    async pnrHistory(){
      await storeUtils.fireAway().itineneryStore.updateOpenPnrHistoryModal(true)
      await storeUtils.fireAway().itineneryStore.updateCurrentPnrHistoryChatId(this.flightId)
...
<!--            @click="e => showAction(e, 'special_request')"-->
          ...
          <div class="action_wrapper" @click="pnrHistory">
            <div class="action_items">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
