                ...
                <div v-for="(j, index) in data" :key="index + 1 * 232">
                    ...
                    >
                        ...
                        <span
                            ...
                            :class="{
                                pending: !j.status || j.status == 'inactive',
                            }"
                            v-if="
                                h.key === 'status' &&
                                j.hasOwnProperty('markup_value')
                            "
                            >{{ j.status ? j.status : "inactive" }}</span
                        >
                        ...
                        <span
                            v-else-if="
                                h.label.toLowerCase() === 'domain name' &&
                                j.is_primary === 1
                            "
                        >
                            {{ j.domain }}
                        ...
                        >
                            ...
                            >
                                ...
                                <div v-if="j.hasOwnProperty('markup_value')">
                                    <p
                                        @click="$emit('editMarkup', j)"
                                        class="menu-item"
                                    >
                                        Edit
                                    </p>
                                    <p
                                        @click="$emit('cloneMarkup', j)"
                                        class="menu-item"
                                    >
                                        Clone
                                    </p>
                                    <p
                                        @click="$emit('deleteMarkup', j)"
                                        class="menu-item deactivate"
                                    >
                                        Delete
                                    </p>
                        ...
                        <span
                            v-else-if="
                                h.label.toLowerCase() === 'name' && j.first_name
                            "
                        ...
                        <span
                            v-else-if="
                                h.label.toLowerCase() === 'wallet balance'
                            "
                        ...
                        <span
                            v-else-if="h.label.toLowerCase() === 'no.of member'"
                            >{{ j?.users?.length }}</span
                        >
