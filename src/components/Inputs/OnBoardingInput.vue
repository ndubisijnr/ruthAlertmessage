<template>
  <div class="on_boarding_input">
    ...
    <input :id="id" :style="width ? {width:width} :  null "  :type="type" class="formInput" :placeholder="placeholder"  :class="{'focused':isFocused}" :readonly="readonly" v-model="inputValue" @focus="handleFocus" @focusout="handleFocusOut" @input="emitValue" />
...
export default {
  ...
  props:['type', 'className','label','width','id', 'error','required', 'placeholder', 'readonly'],
  data(){
    return{
      inputValue:null,
      isFocused:false
