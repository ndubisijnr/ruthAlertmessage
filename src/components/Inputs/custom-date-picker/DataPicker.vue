<template>
  ...
  <label>{{ label }} </label>
  <VueDatePicker :max-date="max_date" :min-date="min_date" :readonly="readonly" :model-value="inputDate" @update:model-value="setDate" :format="format" :enable-time-picker="false" auto-apply :clearable="false" position="left" :month-change-on-scroll="false">
...
export default {
  name: "DataPicker",
  props:['value', 'label', 'min_date', 'max_date', 'readonly'],
