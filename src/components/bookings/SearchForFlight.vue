                ...
                <div class="booking-div-body">
                    <div v-if="activeService === 'Flight'">
                        ...
                        >
                            <div>
                                <img
                                    src="../../../src/assets/Cards/LAUNCH.svg"
                                />
                            </div>
                            <div>
                                <p
                                    ...
                                    "
                                >
                                    Hello {{ getUser?.first_name }}, to get
                                ...
                                <p
                                    ...
                                    "
                                >
                                    Please complete your setup to access your
                                    full Travel Yakata services
                                </p>
                            </div>
                            <div>
                                <router-link
        ...
        multiCitySearchFrom(index) {
            ...
            if (this.multiCityFromQuery?.length < 1) {
                ...
                this.filteredAirportFrom = this.getAirports.filter((it) => {
                    ...
                    return (
                        it.city_code ===
                            this.multiCityFromQuery?.toUpperCase() ||
                        it.city.toLowerCase() ===
            ...
            if (this.multiCityToQuery.length < 1) {
                ...
                this.filteredAirportTo = this.getAirports.filter((it) => {
                    ...
                    return (
                        ...
                        it.city.toLowerCase() ===
                            this.multiCityToQuery.toLowerCase() ||
                        it.country.toLowerCase() ===
                            this.multiCityToQuery.toLowerCase() ||
                        it.iata_code.toLowerCase() ===
                            this.multiCityToQuery.toLowerCase()
            ...
            if (type === "multiCity") {
                ...
                if (this.activeDestType === "round_trip") {
                    ...
                    if (!this.destination || !this.return_date) {
                        ...
                        localStorage.flightModel = JSON.stringify(
                            this.flightModel
                        );
