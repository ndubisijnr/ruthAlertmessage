    ...
    <div class="modal">
      ...
      <div class="wrapper">
        ...
        <div>
          ...
          <on-boarding-input id="banks" width="100%" label="Bank Name" @inputValue="(value) => handleFilter(value)"></on-boarding-input>
          ...
          <on-boarding-input width="100%"  label="Account Number" @inputValue="value => model.account_number = value"></on-boarding-input>

          <on-boarding-input width="100%" label="Account Name" @inputValue="value => model.account_name = value"></on-boarding-input>
