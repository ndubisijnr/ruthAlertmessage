      ...
      <div class="main">
        <div class="modal-body">
          ...
          <div class="choose-role">
            ...
            <div v-show="choosePermissions === 'full'" v-for="(i, index) in getPermissions" :key="index">
            ...
            <div v-show="choosePermissions === 'custom'" v-for="(i, key, index) in getPermissions" :key="index">
