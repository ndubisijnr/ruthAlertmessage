  ...
  methods:{
    ...
    submitRequest(){
      ...
      if(!this.model.passengers.length){
        let ticket_error = document.getElementById('exhange_ticket_error')
  ...
  <layout v-slot:children>
    <div class="modal">
      <div class="modal-header">
        <p class="add-team-member">Exchange (Re-issue)</p>
      ...
      <div class="main">
        <div class="modal-body">
              ...
              <div v-for="(i, index) in data?.tickets" :key="index" style="display: flex;gap:1.5rem;align-items: center;justify-content: flex-start;margin-bottom: 0.5rem;">
                ...
                <div style="padding: 0.25rem 0.75rem;border-radius: 1.25rem;background: #EAF0F7;">
                  <div style="display: flex;gap: 0.5rem;">
                    <input :id="`exchange_check_box${index}`" type="checkbox" checked="true" @change="toggleTravelersTicket(`exchange_check_box${index}`,i.traveler, {name:i.traveler, ticket_numbers:i.ticket_number})"/>
          ...
          <div>
            <div style="margin-bottom: 0.75rem">
              <label class="class_label">Exchange (Re-issue) Request <span class="required">*</span></label>
        ...
        <p class="animate__animated animate__shakeX" id="exhange_ticket_error" style="text-transform: capitalize;font-size:1rem;color: rgb(184, 7, 7);display: none;">please select at least one ticket to exchange(re-issue)!</p>
