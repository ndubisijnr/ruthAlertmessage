  ...
  <layout v-slot:children>
    <div class="modal">
      <div class="modal-header">
        <p class="add-team-member">Update Role</p>
        ...
        <div class="modal-body">
          ...
          <div class="email-area">
            <div class="on_boarding_input">
              ...
              <input id="invite-input"  :class="{'focused':isFocused}" v-model="model.name" @focus="handleFocus" @focusout="handleFocusOut"  type="email" class="formInput" :placeholder="model.name" />
            </div>
...
export default {
  ...
  methods:{
    ...
    createRole(){
      if(this.model.name !== null){
        ...
        storeUtils.fireAway().settings?.updateRole().then(() => {
    ...
    pushRole(id){
      ...
      console.log(this.model.permission_ids)
    },

    removeRole(id){
      this.model.permission_ids = this.model.permission_ids.filter(it =>{
        return it !== id
      })
    },
  ...
  mounted() {
    if(this.getTenantLoaded)storeUtils.fireAway().settings?.readAllPermissions();
  }
}
</script>
