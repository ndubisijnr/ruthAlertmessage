        ...
        <div class="modal_child_wrapper">
            ...
            <div class="modal_child_wrapper_body">
                ...
                <div class="domain-registration">
                    <p class="title">Fill-up details</p>
                    
                    <div style="margin-top: 1.5rem;">
                        <OnBoardingInput label="First Name" @inputValue="value => accountOfficersModel.first_name = value"></OnBoardingInput>

                        <OnBoardingInput label="Last Name" @inputValue="value => accountOfficersModel.last_name = value"></OnBoardingInput>
            ...
            <div class="modal_child_wrapper_footer">
                <OnBoardingButton :loading="getLoading" border="none" @click="addAccountOfficer" :disabled="getLoading" textNode="Add Account Officer"></OnBoardingButton>
            </div>
        </div>
...
export default{
    ...
    data(){
        return{
            accountOfficersModel:AccountOfficerRequest.create
        }
    },
    methods:{
        close(){
    ...
    addAccountOfficer(){
      ...
      storeUtils.fireAway().travelAgent?.addAccountOfficers(user.id, this.accountOfficersModel)
    }
    },
