      ...
      >
        ...
        <div class="child__wrapper align_auto flex-column">
          ...
          <div class="child_header">
            <h3>New Markup</h3>
            <p>
              Your mark up details will be applied to the prices of all flights
              results returned
            </p>
              ...
              <div class="mark_up_select flex_between">
                <div class="left_section d-flex align-center">
                  <svg
                    ...
                    fill="none"
                  >
                    <rect width="48" height="48" rx="10" fill="#EAF0F7" />
                    <rect
                      x="8"
                      y="8"
                      width="32"
            ...
            <div class="progression_wrapper flex_between">
              <p :class="{ active: !tabIndicator }">General Mark-Up Details</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="81"
                height="9"
              ...
              <p :class="{ active: tabIndicator === 1 }">Applicable Rule</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="81"
                height="9"
              ...
              <p :class="{ active: tabIndicator === 2 }">Exclusion Rule</p>
            </div>
          </div>
          <!-- body content -->
          <div class="relative child_body">
            ...
            <template v-else-if="tabIndicator === 1">
              <!-- main wrapper -->
              <div class="transIn child_body_wrapper second_slide">
                <div
                ...
                >
                  <div
                    ...
                    :key="id + 998866"
                    :class="{
                      'col-12': (key == 0 && id <= 3) || key == 2,
                      'col-6': id > 3 || key == 1,
                      mudulo:
                        (id > 3 && id % 2 !== 0) || (key == 1 && id % 2 !== 0),
                    }"
                  >
                    <MultiSelect
                      :objectKey="key"
      ...
      .child__wrapper {
        ...
        .child_body {
          ...
          select {
            ...
            cursor: pointer;
            padding-right: 30px;
            background: url("../../assets/arrow_down.svg") calc(100% - 15px)
              center no-repeat;
            appearance: none;
