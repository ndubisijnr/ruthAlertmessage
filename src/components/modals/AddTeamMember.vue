      ...
      <div class="modal-body">
        ...
        <div class="email-area">
          <div class="on_boarding_input">
            ...
            <input @keyup="checkComma" autocomplete="off" :class="{'focused':isFocused}" v-model="inputValue" @focus="handleFocus" @focusout="handleFocusOut"  type="email" class="formInput" placeholder="Start by typing an email address" />
