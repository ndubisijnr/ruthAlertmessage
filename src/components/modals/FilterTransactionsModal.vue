...
export default {
  ...
  data(){
    return{
      ...
      transFrom:null,
      transTo:null,
      model:TransactionRequest.FilterTransactionRequest
    }
  },
  methods: {
    updateFromDateValue(obj) {
      this.transFrom = obj.formattedDate;
    },

    updateToDateValue(obj) {
      this.transTo = obj.formattedDate;
    },
  ...
  components:{OnBoardingButton, Layout,DataPicker},
  computed:{
    getTheme(){
  ...
  <layout v-slot:children>
    <div class="modal">
      <div class="modal-header">
        <p class="add-team-member">Filter Transactions</p>
          ...
          <div class="filter_card">
            <div style="border-radius: 0.75rem;border: 1px solid #E5E9F2;padding: 1.5rem;">
              <div>
                <div>
                  <p>From:</p>
                  <data-picker @dateValue="updateFromDateValue" :max_date="new Date()"></data-picker>
                </div>
                <div>
                  <p>To:</p>
                  <data-picker @dateValue="updateToDateValue" :min_date="new Date(this.transFrom)"></data-picker>
                </div>
              </div>
