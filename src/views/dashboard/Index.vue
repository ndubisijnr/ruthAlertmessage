     ...
     <div class="mb" v-if="getCurrentRoute === 'Dashboard'">
      <div>
        <div v-if="getCurrentRoute === 'Dashboard'">
          <h3 class="user-name" style="margin-top: 3.5rem" v-show="getBusinessProfile?.id_document && getBusinessProfile?.cac_document"> Hello {{getUser?.first_name}} {{getUser?.last_name}} . </h3>
