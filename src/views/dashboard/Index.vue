                            ...
                            <div class="with-tiqwa">
                                <div>
                                    <h3 class="with-tiqwa-h">
                                        Hello,{{ getUser?.first_name }}, get
                                        started with Travel Yakata 🎉
                                    </h3>
                                    <p class="with-tiqwa-p">
                                        Please complete your setup to access
                                        Travel Yakata services,
                                    </p>
                                </div>
                                <div
                                    style="
                  ...
                  <div style="display: flex;align-items: center;justify-content: start">
                    ...
                    >
                        ...
                        >
                            <div
                                class="dest-abv"
                                v-if="getFlightResult[0]?.outbound"
                            >
                                <p class="dest-abv-it">
                                    {{
                                        getCityByCityCode(
                                            getFlightResult[0]?.outbound[0]
                                                ?.airport_from
                                        )
                                    }}
                                    ({{
                            ...
                            >
                                <div class="search-info-area">
                                    ...
                                    <p class="search-info">
                                        {{
                                            getFlightResult[0]?.price_summary[0]
                                                ?.quantity
                                        }}
                                        Passengers
                                    </p>
                        ...
                        <div class="dest-abv" v-else>
                            <div class="dest-abv">
                                <p class="dest-abv-it">
                                    {{
                                        getCityByCityCode(
                                            getFlightResult[0]?.routes[0]
                                                .segments[0]?.airport_from
                                        )
                                    }}
                                    ({{
                                        getFlightResult[0]?.routes[0]
...
export default {
    ...
    methods: {
        ...
        openDrop(value) {
            ...
            if (value === "class") {
                ...
                if (this.showPassengers)
                    editSearchDiv.classList.add("additional");
                else editSearchDiv.classList.remove("additional");
            }
        },
        ...
        getCityByCityCode(city_code) {
            ...
            if (airports) {
                const cityName = airports.filter(
                    (it) => it.iata_code === city_code
                )[0]?.city;
                return cityName;
            }
        },
