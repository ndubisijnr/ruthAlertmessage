        ...
        <div class="m6-0">
          ...
          <div class="navigation-links" id="nav">
            ...
            <router-link v-if="getUser?.account_type === 'super_admin'" :to="`/agents/${getUser?.access_token?.slice(0,20)}`">
              <div class="links-item" :style="getCurrentRoute.includes('dashboard') ? {backgroundColor:custom_theme ? lightenColor(custom_theme.color) : lightenColor(default_theme.color)} : {}" :class="{'active':getCurrentRoute.includes('agents')}">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
            ...
            <router-link :to="`/hotels/${getUser?.access_token?.slice(0,20)}`"><div class="links-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                <path d="M18.543 18.959H1.87634C1.53468 18.959 1.25134 18.6757 1.25134 18.334C1.25134 17.9923 1.53468 17.709 1.87634 17.709H18.543C18.8847 17.709 19.168 17.9923 19.168 18.334C19.168 18.6757 18.8847 18.959 18.543 18.959Z" :fill="custom_theme ? custom_theme.color : default_theme.color"/>
                <path d="M3.29321 18.3343H2.04321L2.08488 8.30923C2.08488 7.6009 2.40988 6.94259 2.96821 6.50925L8.80155 1.96758C9.62655 1.32591 10.7849 1.32591 11.6182 1.96758L17.4516 6.50091C18.0016 6.93425 18.3349 7.60923 18.3349 8.30923V18.3343H17.0849V8.31757C17.0849 8.00091 16.9349 7.69258 16.6849 7.49258L10.8515 2.95925C10.4765 2.66758 9.95155 2.66758 9.56822 2.95925L3.73488 7.50092C3.48488 7.69259 3.33488 8.00091 3.33488 8.31757L3.29321 18.3343Z" :fill="custom_theme ? custom_theme.color : default_theme.color"/>
                <path d="M14.3764 18.9577H6.04309C5.70142 18.9577 5.41809 18.6743 5.41809 18.3327V10.416C5.41809 9.38268 6.25976 8.54102 7.29309 8.54102H13.1264C14.1598 8.54102 15.0014 9.38268 15.0014 10.416V18.3327C15.0014 18.6743 14.7181 18.9577 14.3764 18.9577ZM6.66809 17.7077H13.7514V10.416C13.7514 10.0743 13.4681 9.79102 13.1264 9.79102H7.29309C6.95142 9.79102 6.66809 10.0743 6.66809 10.416V17.7077Z" :fill="custom_theme ? custom_theme.color : default_theme.color"/>
                <path d="M8.54309 15.416C8.20142 15.416 7.91809 15.1327 7.91809 14.791V13.541C7.91809 13.1993 8.20142 12.916 8.54309 12.916C8.88476 12.916 9.16809 13.1993 9.16809 13.541V14.791C9.16809 15.1327 8.88476 15.416 8.54309 15.416Z" :fill="custom_theme ? custom_theme.color : default_theme.color"/>
                <path d="M11.4597 6.875H8.95972C8.61805 6.875 8.33472 6.59167 8.33472 6.25C8.33472 5.90833 8.61805 5.625 8.95972 5.625H11.4597C11.8014 5.625 12.0847 5.90833 12.0847 6.25C12.0847 6.59167 11.8014 6.875 11.4597 6.875Z" :fill="custom_theme ? custom_theme.color : default_theme.color"/>
              </svg>
              <span class="links">Analytics</span>
            </div></router-link>

<!--              <router-link :to="`/insurance/${getUser?.access_token?.slice(0,20)}`"><div class="links-item">-->
<!--              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">-->
<!--                <path d="M12.7097 18.9577H7.70968C3.18468 18.9577 1.25134 17.0243 1.25134 12.4993V7.49935C1.25134 2.97435 3.18468 1.04102 7.70968 1.04102H12.7097C17.2347 1.04102 19.168 2.97435 19.168 7.49935V12.4993C19.168 17.0243 17.2347 18.9577 12.7097 18.9577ZM7.70968 2.29102C3.86801 2.29102 2.50134 3.65768 2.50134 7.49935V12.4993C2.50134 16.341 3.86801 17.7077 7.70968 17.7077H12.7097C16.5513 17.7077 17.918 16.341 17.918 12.4993V7.49935C17.918 3.65768 16.5513 2.29102 12.7097 2.29102H7.70968Z" fill="#1B041C"/>-->
<!--                <path d="M13.543 16.4577H6.87634C4.85968 16.4577 3.75134 15.3493 3.75134 13.3327V6.66602C3.75134 4.64935 4.85968 3.54102 6.87634 3.54102H13.543C15.5597 3.54102 16.668 4.64935 16.668 6.66602V13.3327C16.668 15.3493 15.5597 16.4577 13.543 16.4577ZM6.87634 4.79102C5.55968 4.79102 5.00134 5.34935 5.00134 6.66602V13.3327C5.00134 14.6493 5.55968 15.2077 6.87634 15.2077H13.543C14.8597 15.2077 15.418 14.6493 15.418 13.3327V6.66602C15.418 5.34935 14.8597 4.79102 13.543 4.79102H6.87634Z" fill="#1B041C"/>-->
<!--                <path d="M6.44301 12.7077H4.37634C4.03468 12.7077 3.75134 12.4243 3.75134 12.0827C3.75134 11.741 4.03468 11.4577 4.37634 11.4577H6.44301C7.25134 11.4577 7.90134 10.7993 7.90134 9.99935C7.90134 9.19935 7.24301 8.54102 6.44301 8.54102H4.37634C4.03468 8.54102 3.75134 8.25768 3.75134 7.91602C3.75134 7.57435 4.03468 7.29102 4.37634 7.29102H6.44301C7.93467 7.29102 9.15134 8.50768 9.15134 9.99935C9.15134 11.491 7.94301 12.7077 6.44301 12.7077Z" fill="#1B041C"/>-->
<!--                <path d="M16.0431 8.94922H13.5431C13.2014 8.94922 12.9181 8.66589 12.9181 8.32422C12.9181 7.98255 13.2014 7.69922 13.5431 7.69922H16.0431C16.3848 7.69922 16.6681 7.98255 16.6681 8.32422C16.6681 8.66589 16.3848 8.94922 16.0431 8.94922Z" fill="#1B041C"/>-->
<!--                <path d="M16.0431 12.291H13.5431C13.2014 12.291 12.9181 12.0077 12.9181 11.666C12.9181 11.3243 13.2014 11.041 13.5431 11.041H16.0431C16.3848 11.041 16.6681 11.3243 16.6681 11.666C16.6681 12.0077 16.3848 12.291 16.0431 12.291Z" fill="#1B041C"/>-->
<!--                <path d="M6.25142 10.8338C6.14309 10.8338 6.03475 10.8088 5.93475 10.7672C5.83475 10.7255 5.74309 10.6672 5.65975 10.5922C5.50142 10.4339 5.41809 10.2255 5.41809 10.0005C5.41809 9.78383 5.50975 9.56715 5.65975 9.40882C5.89309 9.18382 6.25976 9.10052 6.56809 9.23385C6.67643 9.27552 6.7681 9.33382 6.8431 9.40882C6.9931 9.56715 7.08476 9.78383 7.08476 10.0005C7.08476 10.2255 7.00143 10.4339 6.8431 10.5922C6.75976 10.6672 6.66809 10.7255 6.56809 10.7672C6.46809 10.8088 6.35976 10.8338 6.25142 10.8338Z" fill="#1B041C"/>-->
<!--              </svg>-->
<!--              <span class="links">Insurance</span>-->
<!--            </div></router-link>-->
          </div>
