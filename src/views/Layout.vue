          ...
          <div class="navigation-links" id="nav">
            ...
            <router-link :to="`/transaction/${getUser?.access_token?.slice(0,20)}`"><div class="links-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                ...
                <path d="M7.01801 17.291H6.87634C6.53468 17.291 6.25134 17.0077 6.25134 16.666C6.25134 16.3243 6.53468 16.041 6.87634 16.041H7.01801C7.35968 16.041 7.64301 16.3243 7.64301 16.666C7.64301 17.0077 7.35968 17.291 7.01801 17.291Z" fill="#1B041C"/>
              </svg>
            ...
            <router-link :to="`/hotels/${getUser?.access_token?.slice(0,20)}`"><div class="links-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                <path d="M18.543 18.959H1.87634C1.53468 18.959 1.25134 18.6757 1.25134 18.334C1.25134 17.9923 1.53468 17.709 1.87634 17.709H18.543C18.8847 17.709 19.168 17.9923 19.168 18.334C19.168 18.6757 18.8847 18.959 18.543 18.959Z" fill="#1B041C"/>
                <path d="M3.29321 18.3343H2.04321L2.08488 8.30923C2.08488 7.6009 2.40988 6.94259 2.96821 6.50925L8.80155 1.96758C9.62655 1.32591 10.7849 1.32591 11.6182 1.96758L17.4516 6.50091C18.0016 6.93425 18.3349 7.60923 18.3349 8.30923V18.3343H17.0849V8.31757C17.0849 8.00091 16.9349 7.69258 16.6849 7.49258L10.8515 2.95925C10.4765 2.66758 9.95155 2.66758 9.56822 2.95925L3.73488 7.50092C3.48488 7.69259 3.33488 8.00091 3.33488 8.31757L3.29321 18.3343Z" fill="#1B041C"/>
                <path d="M14.3764 18.9577H6.04309C5.70142 18.9577 5.41809 18.6743 5.41809 18.3327V10.416C5.41809 9.38268 6.25976 8.54102 7.29309 8.54102H13.1264C14.1598 8.54102 15.0014 9.38268 15.0014 10.416V18.3327C15.0014 18.6743 14.7181 18.9577 14.3764 18.9577ZM6.66809 17.7077H13.7514V10.416C13.7514 10.0743 13.4681 9.79102 13.1264 9.79102H7.29309C6.95142 9.79102 6.66809 10.0743 6.66809 10.416V17.7077Z" fill="#1B041C"/>
                <path d="M8.54309 15.416C8.20142 15.416 7.91809 15.1327 7.91809 14.791V13.541C7.91809 13.1993 8.20142 12.916 8.54309 12.916C8.88476 12.916 9.16809 13.1993 9.16809 13.541V14.791C9.16809 15.1327 8.88476 15.416 8.54309 15.416Z" fill="#1B041C"/>
                <path d="M11.4597 6.875H8.95972C8.61805 6.875 8.33472 6.59167 8.33472 6.25C8.33472 5.90833 8.61805 5.625 8.95972 5.625H11.4597C11.8014 5.625 12.0847 5.90833 12.0847 6.25C12.0847 6.59167 11.8014 6.875 11.4597 6.875Z" fill="#1B041C"/>
              </svg>
