        ...
        <div class="m6-0">
          ...
          <div class="navigation-links" id="nav">
            ...
            <router-link :to="`/transaction/${getUser?.access_token?.slice(0,20)}`">
              <div class="links-item" :class="{'active':getCurrentRoute.includes('bookings')}" :style="getCurrentRoute.includes('transaction') ? {backgroundColor:custom_theme ? lightenColor(custom_theme.color) : lightenColor(default_theme.color)} : {}">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
