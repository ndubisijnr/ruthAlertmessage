    ...
    <div v-if="getTenantLoaded" class="wrapper">
        <div class="inner-wrapper">
            <NavBar v-slot:children>
                <div class="m6-0">
                    <router-link
                        :to="`/dashboard/${getUser?.access_token?.slice(
                            0,
                            20
                        )}`"
                    >
                    ...
                    >
                        ...
                        >
                            <div
                                ...
                                "
                                :class="{
                                    active: getCurrentRoute.includes(
                                        'dashboard'
                                    ),
                                }"
                            >
                        ...
                        <router-link
                            v-if="
                                ...
                                getUser.account_type === 'admin'
                            "
                            :to="`/agents/${getUser?.access_token?.slice(
                                0,
                                20
                            )}`"
                        >
                        ...
                        <router-link
                            :to="`/transaction/${getUser?.access_token?.slice(
                                0,
                                20
                            )}`"
                        >
                        ...
                        >
                            ...
                            <div class="dropDown-inner-main">
                                <div class="dropDown-item">
                                    ...
                                    <img
                                        v-if="
                                            getCurrentRoute.includes('settings')
                                        "
