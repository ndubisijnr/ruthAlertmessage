          ...
          <div class="tab-nav">
            ...
            >
              ...
              <a
                ...
                href="#Customization"
                @click="activateTab('Customization'), (isEditing = true)"
                >Customization</a
              >
            </ul>
          </div>
                    ...
                    <form>
                      <div class="grouped_input">
                        <div class="on_boarding_input">
                          <label class="label" :class="{ focused: isFocused }"
                            >First Name</label
                          >
                          <input
                            id="first_name"
                ...
                <div v-if="activeManageRole === 'team'">
                  <div v-if="getMembers?.length > 0" class="table-wrapper">
                    <domain-table
                      ...
                      @deactivatingTeamMember="deactivateTeamMember"
                      :is-paginate="true"
                      :data="
                    ...
                    <div class="no-team-member-text">
                      <div style="text-align: center">
                        <p class="no-team-member-h">
                          Hi {{ getBusinessProfile?.name }}, you have not added
                          any team member yet!
                        </p>
                ...
                <div v-else>
                  ...
                  <div v-else class="no-team-member">
                    ...
                    <div class="no-team-member-text">
                      <div style="text-align: center">
                        <p class="no-team-member-h">
                          Hi {{ getBusinessProfile?.name }}, you have not
                          created any role yet!
                        </p>
                        <p class="no-team-member-sub">
              ...
              <div v-else class="no-team-member">
                ...
                <div class="no-team-member-text">
                  <div style="text-align: center">
                    ...
                    <p class="no-team-member-sub">No Team Member Found.</p>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <img
                        ...
                        @click="
                          (getNotifications.message_email_notification = 0),
                            updateNotification()
                        "
                        v-if="getNotifications?.message_email_notification"
                      />
                      <img
                        src="../../assets/Switchoff.svg"
                        @click="
                      ...
                      <img
                        ...
                        @click="
                          (getNotifications.reminder_in_app_notification = 0),
                            updateNotification()
                        "
                        v-if="getNotifications?.reminder_in_app_notification"
                      />
                      <img
                        src="../../assets/Switchoff.svg"
                        @click="
                      ...
                      <img
                        ...
                        @click="
                          (getNotifications.reminder_email_notification = 0),
                            updateNotification()
                        "
                        v-if="getNotifications?.reminder_email_notification"
                      />
                      <img
                        src="../../assets/Switchoff.svg"
                        @click="
                      ...
                      <img
                        ...
                        @click="
                          (getNotifications.reminder_sms_notification = 0),
                            updateNotification()
                        "
                        v-if="getNotifications?.reminder_sms_notification"
                      />
                      <img
                        src="../../assets/Switchoff.svg"
                        @click="
                      ...
                      <img
                        ...
                        @click="
                          (getNotifications.ads_newsletter_sms_notification = 0),
                            updateNotification()
                        "
                        v-if="getNotifications?.ads_newsletter_sms_notification"
                      />
                      <img
                        src="../../assets/Switchoff.svg"
                        @click="
                  ...
                  <div class="payment-choice">
                    ...
                    <p
                      ...
                      :style="
                        paymentType === 'bank'
                          ? {
                              borderBottomColor: custom_theme
                                ? custom_theme.color
                                : default_theme.color,
                            }
                          : null
                      "
                      :class="{ payment_type_active: paymentType === 'bank' }"
                  ...
                  <div v-if="paymentType === 'bank'">
                    <div v-if="getBankAccount?.length > 0">
                      <div class="bank-wrapper">
                        <div
                          class="bank-card"
                          v-for="(i, index) in getBankAccount"
                          :key="index"
                        >
                          <div
                            v-if="getUser.account_type === 'super_admin'"
                    ...
                    <div v-else class="no-team-member">
                      ...
                      <div class="no-team-member-text">
                        <div style="text-align: center">
                          <p class="no-team-member-h">
                            Hi {{ getBusinessProfile?.name }}, let’s set up your
                            account now!
                          </p>
                          <p class="no-team-member-sub">
              ...
              <div v-if="false" class="markups-wrapper">
                <div class="markup-item">
                  <div>
                    ...
                    <p class="m-2">
                      Your mark up details will be applied to the prices of all
                      local flights results returned
                    </p>
                  </div>
                  ...
                  <div class="form-area">
                    <on-boarding-input
                      ...
                      "
                      @inputValue="
                        (value) => (markupModel.domestic_markup_value = value)
                      "
                    ></on-boarding-input>
                    <div
                      ...
                      <div style="">
                        ...
                        <div class="doc_type_options" v-show="localDropdown">
                          <p
                            class="doc_type_item"
                            @click="
                              (LocalMarkUpPlaceHolder = 'Fixed'),
                                toggleLocalDropdown(),
                                (markupModel.domestic_markup_type = 'fixed')
                            "
                          >
                            fixed
                          </p>
                          <p
                            class="doc_type_item"
                            @click="
                              (LocalMarkUpPlaceHolder = 'Percentage'),
                                toggleLocalDropdown(),
                    ...
                    <div class="item">
                      ...
                      <img
                        ...
                        v-if="getMarkup?.domestic_markup_per_passenger === 1"
                        src="../../assets/Switchon.svg"
                      />
                    ...
                    <div class="item">
                      ...
                      <img
                        ...
                        src="../../assets/Switchon.svg"
                        v-if="getMarkup?.domestic_markup_per_route === 1"
                      />
                ...
                <div class="markup-item">
                  ...
                  <div class="form-area">
                    <on-boarding-input
                      ...
                      @inputValue="
                        (value) =>
                          (markupModel.international_markup_value = value)
                      "
                    ></on-boarding-input>
                    <div
                      class="choose_document_type"
                      ...
                      <div style="">
                        ...
                        <div class="doc_type_options" v-show="intDropdown">
                          ...
                          <p
                            class="doc_type_item"
                            @click="
                              (IntMarkUpPlaceHolder = 'Percentage'),
                                toggleIntDropdown(),
                                (markupModel.international_markup_type =
                                  'Percentage')
                            "
                    ...
                    <div class="item">
                      ...
                      <img
                        ...
                        v-if="
                          getMarkup?.international_markup_per_passenger === 1
                        "
                        src="../../assets/Switchon.svg"
                      />
                    ...
                    <div class="item">
                      ...
                      <img
                        ...
                        src="../../assets/Switchon.svg"
                        v-if="getMarkup?.international_markup_per_route === 1"
                      />
