          ...
          <div class="tab-nav">
            ...
            >
              ...
              >
                ...
                <a
                  :class="{
                    active: currentTab === 'office-id',
                  }"
                  href="#office-id"
                  @click="activateTab('office-id')"
                  >Office ID</a
                >
              </template>
              <a
                ...
                <div>
                  <div class="payment-choice">
                    ...
                    <p
                      ...
                      "
                      :class="{
                        payment_type_active: paymentType === 'bank',
                      }"
            ...
            >
              ...
              <header class="mb-0 flex_between">
                <div class="search-team">
                  ...
                  <input
                    :disabled="!markupSearch && !markup?.data?.length"
                    @input="searchMarkup"
              ...
              <div class="table-wrapper">
                <domain-table
                  ...
                  @cloneMarkup="$refs.markupBuilder.modalMainAction($event)"
                  @deleteMarkup="$refs.markupBuilder.deleteMarkup($event)"
                  :data="markup.data"
...
import deactivateAccountConfirm from "@/components/modals/DeactivateAccountConfirm.vue";
import Office from "@/components/settings/Office.vue";
    ...
    switchTab(value) {
      switch (value) {
        ...
        case "office-id":
          ...
          this.$refs.office.fetchOfficeId();
          break;
        case "Customization":
