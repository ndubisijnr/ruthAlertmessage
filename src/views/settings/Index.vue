<template>
    ...
    <edit-team-member
        v-show="editTeamMember"
        @close="close"
        @opened="closeOpened"
        :opened="opened"
    ></edit-team-member>
    <deactivate-account-confirm
        v-show="isDeactivateAccount"
    ...
    <layout v-slot:child-content>
        <div class="settings-wrapper-navs">
            <div class="settings-main">
                <div>
                    <div class="breadcrumb">
                        ...
                        <div class="breadcrumb-sub">
                            ...
                            <img
                                src="../../assets/VerificationProcess/arrow-left.svg"
                            />
                    ...
                    <div class="tab-nav">
                        ...
                        >
                                ...
                                v-if="
                                    ...
                                    (getUser.account_type === 'admin' &&
                                        ...
                                        getBusinessProfile?.is_id_verified ===
                                            'true')
                                "
                                :class="{ active: currentTab === 'Domain' }"
                                href="#Domain"
                                @click="activateTab('Domain')"
                                >Domain</a
                            >
                            <a
                                v-if="
                            ...
                            <a
                                ...
                                "
                                href="#Notifications"
                                @click="activateTab('Notifications')"
                                >Notifications</a
                            >
                            <a
                                v-if="
                                ...
                                href="#Payment"
                                @click="activateTab('Payment')"
                                >Payment
                            </a>
                            <a
                                :class="{ active: currentTab === 'Markup' }"
                                v-if="
                                    getUser.account_type === 'super_admin' ||
                                    getUser.account_type === 'admin' ||
                                    (getBusinessProfile?.is_cac_verified ===
                ...
                <div class="tabs">
                    <settings-skeletons-loader
                        v-if="loading && teamLoading && rolesLoading"
                    ></settings-skeletons-loader>
                    ...
                    <div v-else>
                        ...
                        <div
                            id="accounts"
                            class="accounts animate__animated animate__fadeIn"
                        ...
                        <div
                            id="domains"
                            class="domains animate__animated animate__fadeIn"
                            v-show="currentTab === 'Domain'"
                        >
                        ...
                        <div
                            id="teams"
                            class="teams animate__animated animate__fadeIn"
                            v-show="currentTab === 'Teams'"
                        >
                            ...
                            <div class="teams-main" v-if="!noUser">
                                <div v-if="activeManageRole === 'team'">
                                    <div
                                        v-if="getMembers?.length > 0"
                                        class="table-wrapper"
                                    >
                                        <domain-table
                                            @updatingTeamMember="updateTeam"
                                            @deactivatingTeamMember="
                                                deactivateTeamMember
                                            "
                                            :is-paginate="true"
                                            :data="
                                                membersFilteredResult.length > 0
                                ...
                                <div v-else>
                                    <div
                                        v-if="getRoles?.length > 0"
                                        class="table-wrapper"
                                    >
                                        <domain-table
                                            @updatingRole="editRole"
                                            :is-paginate="true"
                                            :data="getRoles"
                                            :fields="rolesFields"
                                        ></domain-table>
                        ...
                        <div
                            id="notifications"
                            class="notifications animate__animated animate__fadeIn"
                                    ...
                                    <div class="notification-items">
                                        <div class="item">
                                            ...
                                            <img
                                                ...
                                                src="../../assets/Switchon.svg"
                                                @click="
                                                    (getNotifications.message_in_app_notification = 0),
                                                        updateNotification()
                                                "
                                                v-if="
                                                    getNotifications?.message_in_app_notification
                                                "
                                            />
                                            <img
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                ...
                                                src="../../assets/Switchon.svg"
                                                @click="
                                                    (getNotifications.message_email_notification = 0),
                                                        updateNotification()
                                                "
                                                v-if="
                                                    getNotifications?.message_email_notification
                                                "
                                            />
                                            <img
                                                src="../../assets/Switchoff.svg"
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                ...
                                                "
                                                v-if="
                                                    getNotifications?.message_sms_notification
                                                "
                                            />
                                            <img
                                                src="../../assets/Switchoff.svg"
                                    ...
                                    <div class="notification-items">
                                        <div class="item">
                                            ...
                                            <img
                                                ...
                                                src="../../assets/Switchon.svg"
                                                @click="
                                                    (getNotifications.reminder_in_app_notification = 0),
                                                        updateNotification()
                                                "
                                                v-if="
                                                    getNotifications?.reminder_in_app_notification
                                                "
                                            />
                                            <img
                                                src="../../assets/Switchoff.svg"
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                ...
                                                src="../../assets/Switchon.svg"
                                                @click="
                                                    (getNotifications.reminder_email_notification = 0),
                                                        updateNotification()
                                                "
                                                v-if="
                                                    getNotifications?.reminder_email_notification
                                                "
                                            />
                                            <img
                                                src="../../assets/Switchoff.svg"
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                ...
                                                src="../../assets/Switchon.svg"
                                                @click="
                                                    (getNotifications.reminder_sms_notification = 0),
                                                        updateNotification()
                                                "
                                                v-if="
                                                    getNotifications?.reminder_sms_notification
                                                "
                                            />
                                            <img
                                                src="../../assets/Switchoff.svg"
                                    ...
                                    <div class="notification-items">
                                        <div class="item">
                                            ...
                                            <img
                                                src="../../assets/Switchoff.svg"
                                                @click="
                                                    (getNotifications.ads_newsletter_in_app_notification = 1),
                                                        updateNotification()
                                                "
                                                v-else
                                            />
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                src="../../assets/Switchoff.svg"
                                                @click="
                                                    (getNotifications.ads_newsletter_email_notification = 1),
                                                        updateNotification()
                                                "
                                                v-else
                                            />
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                ...
                                                src="../../assets/Switchon.svg"
                                                @click="
                                                    (getNotifications.ads_newsletter_sms_notification = 0),
                                                        updateNotification()
                                                "
                                                v-if="
                                                    getNotifications?.ads_newsletter_sms_notification
                                                "
                                            />
                                            <img
                                                src="../../assets/Switchoff.svg"
                                                @click="
                                                    (getNotifications.ads_newsletter_sms_notification = 1),
                                                        updateNotification()
                                                "
                                                v-else
                                            />
                        ...
                        <div
                            id="payments"
                            class="payments animate__animated animate__fadeIn"
                            v-show="currentTab === 'Payment'"
                        >
                        ...
                        <div
                            id="markups"
                            class="markups animate__animated animate__fadeIn"
                            v-show="currentTab === 'Markup'"
                        >
                            <div v-if="false" class="markups-wrapper">
                                <div class="markup-item">
                                    <div>
                                        <p class="m-1">Local Markup Details</p>
                                        <p class="m-2">
                                            Your mark up details will be applied
                                            to the prices of all local flights
                                            results returned
                                        </p>
                                    </div>
                                    ...
                                    <div class="form-area">
                                        <on-boarding-input
                                            ...
                                            label="Value"
                                            :placeholder="
                                                getMarkup?.domestic_markup_value
                                                    ? getMarkup?.domestic_markup_value
                                                    : null
                                            "
                                            @inputValue="
                                                (value) =>
                                                    (markupModel.domestic_markup_value =
                                                        value)
                                            "
                                        ></on-boarding-input>
                                        <div
                                        ...
                                        >
                                            <div style="">
                                                <p class="doc_type">
                                                    {{ LocalMarkUpPlaceHolder }}
                                                </p>
                                                <div
                                                    class="doc_type_options"
                                                    v-show="localDropdown"
                                                >
                                                    <p
                                                        class="doc_type_item"
                                                        @click="
                                                            (LocalMarkUpPlaceHolder =
                                                                'Fixed'),
                                                                toggleLocalDropdown(),
                                                                (markupModel.domestic_markup_type =
                                                                    'fixed')
                                                        "
                                                    >
                                                        fixed
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                style="
                                                    ...
                                                    cursor: pointer;
                                                "
                                                @click="setLocalPerPass(0)"
                                                v-if="
                                                    getMarkup?.domestic_markup_per_passenger ===
                                                    1
                                                "
                                                src="../../assets/Switchon.svg"
                                            />
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                style="
                                                    ...
                                                    cursor: pointer;
                                                "
                                                @click="setLocalPerRou(0)"
                                                src="../../assets/Switchon.svg"
                                                v-if="
                                                    getMarkup?.domestic_markup_per_route ===
                                                    1
                                                "
                                            />
                                ...
                                <div class="markup-item">
                                    ...
                                    <div class="form-area">
                                        <on-boarding-input
                                            ...
                                            label="Value"
                                            :placeholder="
                                                getMarkup?.international_markup_value
                                                    ? getMarkup?.international_markup_value
                                                    : null
                                            "
                                            @inputValue="
                                                (value) =>
                                                    (markupModel.international_markup_value =
                                                        value)
                                            "
                                        ></on-boarding-input>
                                        <div
                                                    ...
                                                    <p
                                                        ...
                                                        @click="
                                                            (IntMarkUpPlaceHolder =
                                                                'Fixed'),
                                                                toggleIntDropdown(),
                                                                (markupModel.international_markup_type =
                                                                    'Fixed')
                                                        "
                                                    >
                                                        fixed
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                style="
                                                    ...
                                                    cursor: pointer;
                                                "
                                                @click="setIntPerPass(0)"
                                                v-if="
                                                    getMarkup?.international_markup_per_passenger ===
                                                    1
                                                "
                                                src="../../assets/Switchon.svg"
                                            />
                                        ...
                                        <div class="item">
                                            ...
                                            <img
                                                style="
                                                    ...
                                                    cursor: pointer;
                                                "
                                                @click="setIntPerRou(0)"
                                                src="../../assets/Switchon.svg"
                                                v-if="
                                                    getMarkup?.international_markup_per_route ===
                                                    1
                                                "
                                            />
                                        ...
                                        >
                                            <on-boarding-button
                                                ...
                                                :loading="loading"
                                                :disabled="loading"
                                                @click="doUpdateMarkup"
                                                btn-width="11.0625rem"
                                                text-node="Save Changes"
                                            ></on-boarding-button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-wrapper">
                                <domain-table
                                    @editMarkup="
                                        $refs.markupBuilder.openModal($event)
                                    "
                                    @cloneMarkup="
                                        $refs.markupBuilder.modalMainAction(
                                            $event
                                        )
                                    "
                                    @deleteMarkup="
                        ...
                        <div
                            id="verifications"
                            class="verifications animate__animated animate__fadeIn"
                            v-show="currentTab === 'Verification'"
                        >
                            <business-verification
                                v-if="verification_Type === 'business'"
                                :is-component="false"
                                :in-route="false"
                            ></business-verification>
                            <upload-docs
...
export default {
    ...
    beforeRouteLeave(to, from, next) {
        if (this.isEditing) {
            if (
                !window.confirm(
                    "Are you sure? all unsaved changes won't reflect."
                )
            ) {
                return;
            }
    ...
    mounted() {
        ...
        setTimeout(() => {
            (this.currentTab = this.getCurrentRouteParams),
                this.marry(this.getCurrentRouteParams);
        }, 500);
