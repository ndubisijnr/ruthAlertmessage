  ...
  <layout v-slot:child-content>
    <div class="overall" id="overall">
      <div class="booking-wrapper">
        ...
        <div v-if="getCurrentRoute === 'Bookings'">
        <div class="search_filter">
          ...
          <div class="card-area">
              ...
              <bookings-cards v-else title="Total Bookings" :number="getBookingSum?.total_bookings ? getBookingSum?.total_bookings : '0'"></bookings-cards>
              <bookings-card-loading v-if="getLoadingBooking"></bookings-card-loading>
              ...
              <router-link :to="`/bookings/create_new_booking/${getUser?.access_token?.slice(0,20)}`"><div class="create-booking">
        ...
        <div v-else class="create-booking-process">
