      ...
      <div>
        <div class="search_filter">
            <div class="search">
                ...
                <input v-model="searchQuery" type="search" @input="doFilter" style="outline: none;border: none;width: 19.4rem" placeholder="Search by IDs, names etc"/>
            </div>
            <div class="filter">
              ...
              <on-boarding-button class="filter-btn" btn-width="6.37rem"  background="#F8F1F8" border="none"  color="#89128A"  height="2.5rem" text-node="Export"></on-boarding-button>
